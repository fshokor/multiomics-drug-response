...
Manual step required before running:
    Download: ProCan-DepMapSanger_protein_matrix_6692_averaged.txt (60 MB)
    From:     https://figshare.com/articles/dataset/Pan-cancer_proteomic_map_of_949_human_cell_lines/19345397?file=34411151
    Save to:  data/raw/procan/ProCan-DepMapSanger_protein_matrix_6692_averaged.txt
...
PROCAN_RAW  = ROOT / "data" / "raw" / "procan" / "ProCan-DepMapSanger_protein_matrix_6692_averaged.txt"
...
def convert_procan() -> None:
    ...
    if not PROCAN_RAW.exists():
      ...
      Please download it manually:
        ...
        2. Download: ProCan-DepMapSanger_protein_matrix_6692_averaged.txt (90 MB)
    ...
    print(f"      ProCan raw shape: {procan.shape}")  # expect (949, 6692)
